...
func CreateMemoScreen() createMemoScreen {
	ti := textarea.New()
...
func (m createMemoScreen) Init() tea.Cmd {
	return textinput.Blink
}

func (m createMemoScreen) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case tea.KeyMsg:
		...
		switch msg.String() {
		//Switch focus between sticker and memo controls
		case "tab":
...
func (m *createMemoScreen) updateInputs(msg tea.Msg) tea.Cmd {
	cmds := make([]tea.Cmd, len(m.textInputs))
...
func (m createMemoScreen) View() string {
